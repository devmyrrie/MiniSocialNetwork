...
/**
*   EFE:Verifica si existe una persona en la red
*   REQ:Un objeto tipo Tipo
*   MOD:N/A.
*/
...
/**
*   EFE:Agrega un vertice a la red.
*   REQ:Un objeto tipo Tipo  para agregar a la red.
*   MOD:La lista de la red (vertices).
*/
    ...
    /**
*   EFE:Agrega relacion entre dos vertices
*   REQ:Dos objetos tipo Tipo
*   MOD:La lista de arcos de cada vertice
*/
    ...
    /**
*   EFE:Verifica si dos vertices estan relacionados.
*   REQ:Dos objetos tipo Tipo.
*   MOD:N/A.
*/
...
*/
    ...
    /**
*   EFE:Imprime la lista de personas en la red.
*   REQ:N/A.
*   MOD:N/A.
*/
...
/**
*   EFE:Imprime la lista de vertices .
*   REQ:N/A.
*   MOD:N/A.
*/
...
/**
*   EFE:Imprime la lista de amigos mutuos entre personas.
*   REQ:Dos objetos tipo Tipo.
*   MOD:N/A.
*/
...
/**
*   EFE:Imprime la informacion una persona a la red.
*   REQ:Un objeto tipo person para consultar.
*   MOD: N/A
*/
...
*   REQ: Un objeto tipo Tipo.
*   MOD: La lista de vertices (la red).
*/
...
/**
*   EFE:Elimina la relacion entre dos vertices.
*   REQ:Dos objetos tipo Tipo.
*   MOD:Lista de arcos de cada vertice.
*/
